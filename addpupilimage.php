...
<body>
    <div class="container-scroller" style="height: 100vh">
        ...
        <?php include "./nav.view.php"; ?>
            ...
            <div class="bodyWrapper">
              ...
              display: flex;
            ">
                    <h5 id="hd">Pupils details saved successfully. Now add Image..</h5>
                </div>
            ...
            ">
                    <div class="rightContainer " style="flex-basis: 70%;display:flex;flex-direction:column;height:100%">
                        <div style="display: flex; justify-content: center; align-items: center;flex-basis:10%;">
                            <h3 style="margin-top: 45px;margin-bottom:30px">Pupils Details</h3>
                        </div>
                        <div style="width: 100%; display: flex; align-items:center; flex-basis:90%;flex-direction:column;padding-top:30px">

                            <div class="card" style="display: flex;width:80%;height:60px;flex-direction:row;align-items:center;margin-bottom:10px">
                            ...
                            <?php 
                                if ($resultSql->name !="") {
                                    echo "
                                    <div class='card' style='display: flex;width:80%;height:60px;flex-direction:row;align-items:center;margin-bottom:10px'>
                                    <p style='font-size:20px;margin-right:70px;margin-left:20px;color:#7c7cff'><b>UPI No.</b></p>
                                    <p style='font-size:20px'> $resultSql->upi 
                                </div>
                            ...
                            ?>
                            <div class="card" style="display: flex;width:80%;height:60px;flex-direction:row;align-items:center;margin-bottom:10px">
                                <p style="font-size:20px;margin-right:80px;margin-left:20px;color:#7c7cff"><b>Class</b></p>
                                <p style="font-size:20px"> <?php echo $resultSql->class ?> <?php echo $resultSql->stream ?></p>
                            </div>
                            <div class="card" style="display: flex;width:80%;height:60px;flex-direction:row;align-items:center;margin-bottom:10px">
                                <p style="font-size:20px;margin-right:60px;margin-left:20px;color:#7c7cff"><b>Gender</b></p>
    ...
    justify-content: center;">
                            ...
                            <div id="addedS" style="margin-bottom:10px;color:rgb(112, 112, 243);display:none">
                                Pupil image added successfully
                            </div>
                            <div> <label for="file" id="label" value="no">Add Pupil's Image</label>
                                
                            </div>
                            <div > <a href="./addpupil.php" style="text-decoration: none;"><p  
                            sty>Next Pupil</p></a></div>
...
<script>
    ...
    const changeProfilePic = (files) => {
        ...
        myform.append('type', 'changePupilProfilePic');
    ...
    const handleFileResult = (results) => {
        ...
        switch (f.type) {
            case 'updatePupilProfile':
                ...
                // hd.innerHTML = "Pupils details completed";
                // hd.style.color = "rgb(112, 112, 243)";
                // n.style.display = "flex"

                img.src = f.message
                hd.innerHTML= "<p style='color:green'>pupil image added successfully</p>"

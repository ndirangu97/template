    ...
    <?php include "./nav.view.php"; ?>
      ...
      <div class="bodyWrapper">
        <div id="cardHolder" style="display: flex;
          ...
          $sql = "SELECT * FROM teachers where classteacher=1   ";
          $results = $DB->read($sql, []);
          $dept="";
          $class="";
          ...
          if (is_array($results)) {
            foreach ($results as $row) {
              ...
              if ($row->classteacher==1) {
                if ($row->class!="") {
                  $class="<p style='font-size: 18px;color:#2bb56c'>ClassTeacher $row->class</p>";
                }
              }else{
                $class="";
              }
          ...
          <div style='display: flex; margin: 4px 6px'>
            ...
            echo "No classteachers yet inserted into the database";
          } ?>
...
<script>
    ...
    // alert(url)
    const p = url.replace("http%3A%2F%2Flocalhost%2Ftemplate%2Fteachers.php%3Fpg=", "");
    ...
    const getname=(e)=>{
      if (e.target.value=="") {
        ...
        sendData({name:e.target.value,chaser:"classteacher",},"nameteacher")
      }
